...
module x_carriage_base(){
 ...
 union(){
    ...
    translate([-33/2 +7,-22,25]) rotate([0,45,0]) cube([10,20,8]); // Bruno
 ...
 // Belt holder base
 translate([-42.5,20,0]) cube([52,16,7+offset_correia]); // Piso - Bruno
 
 translate([-16.5-12,24.5,0+offset_correia])cylinder(r=4.5, h=14, $fn=25); // pino esquerdo - Bruno
 translate([-16.5+12,24.5,0+offset_correia])cylinder(r=4.5, h=14, $fn=25);  // pino direito - Bruno
 
 translate([-16.5-12,24.5,14+offset_correia])cylinder(r1=4.5, r2=3.8, h=2, $fn=25); // cone pino esquerdo - Bruno
 translate([-16.5+12,24.5,14+offset_correia])cylinder(r1=4.5, r2=3.8, h=2, $fn=25); // cone pino direito - Bruno
 
  // Endstop trigger nipple
     difference(){  
     union(){
       translate([-2.5,-16,0]) cube([16,5.8,12]);
       translate([-2.2,-12,0])cylinder(r=4.6, h=12, $fn=6); 
       }
       translate([9,-17,-1]) rotate([0,45,0]) cube([10,10,10]);
 ...
 // Belt Insert R
    difference(){
    union(){
    translate([2,27,0+offset_correia]) cube([10,6,15]);
    translate([2,27-2.3-4.5,0+offset_correia]) cube([10,4.5,15]);
    translate([-0.5,27,0]) cube([8,7,2]);
    }
    translate([-3,25,5.5+offset_correia]) rotate([0,0,-40]) cube([5,5.5,10]); // chanfro pega correia direito - Bruno
}
    
 // Belt Insert L
difference(){
    union(){
 translate([-33,3,0]){scale([-1,1,1]){
 translate([0,27,0+offset_correia]) cube([12.5,3,15]);
 translate([2,27-7.5-2.3,0+offset_correia]) cube([12.5,7.5,15]);
 translate([-0.5,27,0]) cube([8,7,2]);
 }}
 
 }
 
 translate([-36.5,27.7,5.5+offset_correia]) rotate([0,0,-55]) cube([5,5.5,10]);
...
module x_carriage_fancy(){
 ...
 // Belt Smooth insert
 translate([0,36.5,23.5+offset_correia]) rotate([45,0,0]) translate([0,-15,0]) cube([20,10,10]); // chanfro pega correia direito - Bruno
 translate([-52.9,36.5+3,23.5+offset_correia]) rotate([45,0,0]) translate([0,-15,0]) cube([20,10,10]); // chanfro pega correia esquerdo - Bruno
...
translate([8.5,21,5]) cube([0.1,3,9.8]);      
    ...
    translate([9,-15.4,-1]) rotate([0,45,0]) cube([0.3,4.6,8]);        
    translate([7.45,6,-1]) cube([0.5,1,5]);        
    translate([7.45,11.5,-1]) cube([0.5,1.8,5]);        
    
    translate([9,-16.4,-1]) rotate([0,45,0]) cube([0.3,0.5,8]);        
    translate([9,-10.3,-1]) rotate([0,45,0]) cube([0.3,0.5,8]);    
