...
void lcd_quick_feedback(const bool clear_buttons) {
  ...
  void lcd_tune_menu() {
    ...
    //
      ...
      //MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(int3, MSG_NOZZLE, &thermalManager.target_temperature[0], 0, HEATER_0_MAXTEMP, watch_temp_callback_E0);                     // BRUNO (01/03/2019)
    #else // HOTENDS > 1
    ...
    //
      ...
      //MENU_MULTIPLIER_ITEM_EDIT_CALLBACK(int3, MSG_BED, &thermalManager.target_temperature_bed, 0, BED_MAXTEMP, watch_temp_callback_bed);                          // BRUNO (01/03/2019)
    #endif
