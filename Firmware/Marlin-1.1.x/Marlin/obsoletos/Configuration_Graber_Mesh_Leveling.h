...
#define STRING_CONFIG_H_AUTHOR "(Bruno Antunes Martins, Graber do Danilo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Graber"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
//#define DEFAULT_MAX_ACCELERATION      { 700, 700, 20, 1000 }
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 50, 2000 }                                                                     // BRUNO (01/03/2019)
...
#define DEFAULT_ACCELERATION          500    // X, Y, Z and E acceleration for printing moves                                   // BRUNO (01/03/2019)
#define DEFAULT_RETRACT_ACCELERATION  2000    // E acceleration for retracts
//#define DEFAULT_TRAVEL_ACCELERATION   700    // X, Y, Z acceleration for travel (non printing) moves
#define DEFAULT_TRAVEL_ACCELERATION   500    // X, Y, Z acceleration for travel (non printing) moves                            // BRUNO (01/03/2019)
